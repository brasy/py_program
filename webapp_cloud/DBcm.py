...
class UseDatabase:
    ...
    def __enter__(self) -> 'cursor':
        ...
        try:
            ...
            return self.cursor
        #means your code cannot find the backend database.
    ...
    def __exit__(self, exc_type, exc_value, exc_traceback):
        ...
        """
        #add code in here and the code raise an exception, the three existing line below willnot executed
        #add code *after* the three existing lines of code ensures "__exit__" does its thing *before* any passed-in exception is dealt with.
        self.conn.commit()
        self.cursor.close()
        self.conn.close()
